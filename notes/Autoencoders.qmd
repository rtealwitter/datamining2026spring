...
* **Invariance under orthogonal transformations**: $\| \mathbf{XV} \|_\text{F}^2 = \| \mathbf{X} \|_\text{F}^2$, where the columns of $\mathbf{V} \in \mathbb{R}^{d \times d}$ are orthonormal.
...
**Note:** We used that $\mathbf{V} \mathbf{V}^\top = \mathbf{I}_d$, can you see why this is true?
...
$$
\| \mathbf{\Sigma} - \mathbf{C} \|_\text{F}^2
= \sum_{i=1}^d (\sigma_i - [\mathbf{C}]_{i,i})^2

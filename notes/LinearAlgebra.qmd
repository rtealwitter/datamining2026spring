...
The derivative of ${f}$ with respect to its input $x$ is mathematically denoted by $f'(x) = \frac{\partial}{\partial x}[{f}(x)]$.
...
Vector and matrix multiplication live at the heart of machine learning.

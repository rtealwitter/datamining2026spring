...
Consider two functions $f: \mathbb{R} \to \mathbb{R}$ and $y: \mathbb{R} \to \mathbb{R}$.
...
The function $v : \mathbb{R}^{d} \to \mathbb{R}$ maps the input(s) parameters $u_1, \ldots, u_d$ to an output, which itself is passed to another function.

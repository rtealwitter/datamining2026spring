...
$$
where $d_j$ is the out-degree of page $j$, i.e., the number of pages that page $j$ links to, and $\mathbb{1}[\cdot]$ is the indicator function that is 1 if the condition is true and 0 otherwise.
